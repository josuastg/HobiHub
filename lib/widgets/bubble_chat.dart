...
class BubbleChat extends StatelessWidget {
  ...
  const BubbleChat({super.key, required this.chat, required this.shouldDisplayName});

  @override
  Widget build(BuildContext context) {
    Color bubbleColor = chat.isSelfChat
        ? const Color(0xFFB55DBE)
        : const Color.fromARGB(255, 231, 231, 231);
    Color messageColor = chat.isSelfChat ? Colors.white : Colors.black;
    Color nameColor = Color(int.parse(chat.colorName.replaceAll("#", "0x"))).withOpacity(1.0);
    return Container(
      alignment: chat.isSelfChat ? Alignment.centerRight : Alignment.centerLeft,
      ...
      child: Container(
        ...
        padding:
            const EdgeInsets.only(top: 9, bottom: 3, left: 20, right: 7),
